...
void  I2C_Slave_Init (void)
{
	...
	I2C0ADM  = 0x8F; //default support A0 addr and not support A2 addr
...
void I2C_slave_enable( bool enable )
{
	...
	if(enable == 0x0)  //module is not selected
	{
...
void I2C_a2_addr_access_enable(bool enable )
{
	uint8_t SFRPAGE_SAVE = SFRPAGE;
	...
	if(enable == 0x0)  //module is not selected
	{
		I2C0ADM  = 0x8F;	//disable A2 i2c slave
	}
	else  // module is selected
	{
		I2C0ADM  = 0x8E;  //enable A2 i2c slave
	}
	SFRPAGE = SFRPAGE_SAVE;
}
