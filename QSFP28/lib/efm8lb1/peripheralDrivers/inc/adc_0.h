...
//typedef uint16_t  ADC0_AutoscanBuffer_t
#endif
/***************************************************************************//**
* @brief
 ...
 *
 ******************************************************************************/
void ADC0_enableAutoscan(ADC0_AutoscanBuffer_t * buffer,
...
*
******************************************************************************/
ADC0_AutoscanBuffer_t * ADC0_getNextAutoscanBuffer(void);
 ...
 *
 ******************************************************************************/
void ADC0_setNextAutoscanBuffer(ADC0_AutoscanBuffer_t * buffer,
                      uint8_t numElements); //Max 64                      
